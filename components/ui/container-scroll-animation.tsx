...
export function ContainerScroll({
  ...
  return (
    <div
      className="relative flex h-[40rem] items-center justify-center p-2 md:h-[55rem] md:p-10"
      ref={containerRef}
    >
      <div
...
function ScrollCard({
  ...
  return (
    <motion.div
      ...
      className="mx-auto h-[24rem] w-full max-w-5xl rounded-[30px] border-4 border-[#6C6C6C] bg-[#222222] p-2 shadow-2xl md:h-[34rem] md:p-4"
    >
